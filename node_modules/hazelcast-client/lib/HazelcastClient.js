...
const ConnectionManager_2 = require("./network/ConnectionManager");
...
class HazelcastClient {
    ...
    constructor(config, failoverConfig) {
        ...
        this.partitionService = new PartitionService_1.PartitionServiceImpl(this.loggingService.getLogger(), this.serializationService);
        this.lifecycleService = new LifecycleService_1.LifecycleServiceImpl(this.config.lifecycleListeners, this.loggingService.getLogger());
        this.clusterFailoverService = this.initClusterFailoverService();
        this.clusterService = new ClusterService_1.ClusterService(this.config, this.loggingService.getLogger(), this.clusterFailoverService);
        this.connectionRegistry = new ConnectionManager_2.ConnectionRegistryImpl(this.config.connectionStrategy, this.config.network.smartRouting, this.loadBalancer, this.clusterService);
        this.invocationService = new InvocationService_1.InvocationService(this.config, this.loggingService.getLogger(), this.partitionService, this.errorFactory, this.lifecycleService, this.connectionRegistry);
        this.connectionManager = new ConnectionManager_1.ConnectionManager(this, this.instanceName, this.config, this.loggingService.getLogger(), this.partitionService, this.serializationService, this.lifecycleService, this.clusterFailoverService, this.failoverConfig != null, this.clusterService, this.invocationService, this.connectionRegistry);
        this.listenerService = new ListenerService_1.ListenerService(this.loggingService.getLogger(), this.config.network.smartRouting, this.connectionManager, this.invocationService, this.connectionRegistry);
        this.lockReferenceIdGenerator = new LockReferenceIdGenerator_1.LockReferenceIdGenerator();
        this.proxyManager = new ProxyManager_1.ProxyManager(this.config, this.loggingService.getLogger(), this.invocationService, this.listenerService, this.partitionService, this.serializationService, this.nearCacheManager, () => this.getRepairingTask(), this.clusterService, this.lockReferenceIdGenerator, this.connectionRegistry);
        this.statistics = new Statistics_1.Statistics(this.loggingService.getLogger(), this.config.properties, this.instanceName, this.invocationService, this.nearCacheManager, this.connectionRegistry);
        this.clusterViewListenerService = new ClusterViewListenerService_1.ClusterViewListenerService(this.loggingService.getLogger(), this.connectionManager, this.partitionService, this.clusterService, this.invocationService, this.connectionRegistry);
        this.cpSubsystem = new CPSubsystem_1.CPSubsystemImpl(this.loggingService.getLogger(), this.instanceName, this.invocationService, this.serializationService);
        this.sqlService = new SqlService_1.SqlServiceImpl(this.connectionRegistry, this.serializationService, this.invocationService, this.connectionManager);
    }
    /**
