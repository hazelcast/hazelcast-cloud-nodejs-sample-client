...
class ReliableTopicProxy extends BaseProxy_1.BaseProxy {
    constructor(serviceName, name, logger, clientConfig, proxyManager, partitionService, invocationService, serializationService, listenerService, clusterService, connectionRegistry) {
