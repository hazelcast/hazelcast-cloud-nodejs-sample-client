...
class PipelinedWriter extends Writer {
    constructor(socket, threshold // coalescing threshold in bytes
    ) {
        super();
        this.socket = socket;
...
/** @internal */
class Connection {
    constructor(connectionManager, clientConfig, logger, remoteAddress, socket, connectionId, lifecycleService) {
