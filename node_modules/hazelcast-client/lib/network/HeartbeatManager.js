...
class HeartbeatManager {
    constructor(properties, logger, connectionRegistry) {
    ...
    start(invocationService) {
        this.task = Util_1.scheduleWithRepetition(this.heartbeatFunction.bind(this, invocationService), this.heartbeatInterval, this.heartbeatInterval);
    }
    /**
