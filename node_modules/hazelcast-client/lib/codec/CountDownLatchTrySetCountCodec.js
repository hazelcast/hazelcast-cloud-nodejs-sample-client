...
exports.CountDownLatchTrySetCountCodec = void 0;
...
// hex: 0x0B0100
const REQUEST_MESSAGE_TYPE = 721152;
// hex: 0x0B0101
// RESPONSE_MESSAGE_TYPE = 721153
const REQUEST_COUNT_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
const REQUEST_INITIAL_FRAME_SIZE = REQUEST_COUNT_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
const RESPONSE_RESPONSE_OFFSET = ClientMessage_1.RESPONSE_BACKUP_ACKS_OFFSET + BitsUtil_1.BitsUtil.BYTE_SIZE_IN_BYTES;
/** @internal */
class CountDownLatchTrySetCountCodec {
    static encodeRequest(groupId, name, count) {
        ...
        FixSizedTypesCodec_1.FixSizedTypesCodec.encodeInt(initialFrame.content, REQUEST_COUNT_OFFSET, count);
...
exports.CountDownLatchTrySetCountCodec = CountDownLatchTrySetCountCodec;
//# sourceMappingURL=CountDownLatchTrySetCountCodec.js.map