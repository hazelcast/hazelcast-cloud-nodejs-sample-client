...
exports.SemaphoreAcquireCodec = void 0;
...
const REQUEST_TIMEOUT_MS_OFFSET = REQUEST_PERMITS_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
...
class SemaphoreAcquireCodec {
    static encodeRequest(groupId, name, sessionId, threadId, invocationUid, permits, timeoutMs) {
