...
class FixSizedTypesCodec {
    ...
    static decodeLocalDate(buffer, offset) {
        ...
        const month = FixSizedTypesCodec.decodeByte(buffer, offset + BitsUtil_1.BitsUtil.SHORT_SIZE_IN_BYTES);
        const date = FixSizedTypesCodec.decodeByte(buffer, offset + BitsUtil_1.BitsUtil.SHORT_SIZE_IN_BYTES + BitsUtil_1.BitsUtil.BYTE_SIZE_IN_BYTES);
        return DatetimeUtil_1.getLocalDateString(year, month, date);
    }
    ...
    static decodeOffsetDateTime(buffer, offset) {
        ...
        const offsetString = DatetimeUtil_1.getTimezoneOffsetFromSeconds(offsetSeconds);
    ...
    static decodeLocalTime(buffer, offset) {
        ...
        return DatetimeUtil_1.getLocalTimeString(hour, minute, second, nano);
    }
