...
exports.FencedLockUnlockCodec = void 0;
...
const REQUEST_INITIAL_FRAME_SIZE = REQUEST_INVOCATION_UID_OFFSET + BitsUtil_1.BitsUtil.UUID_SIZE_IN_BYTES;
const RESPONSE_RESPONSE_OFFSET = ClientMessage_1.RESPONSE_BACKUP_ACKS_OFFSET + BitsUtil_1.BitsUtil.BYTE_SIZE_IN_BYTES;
/** @internal */
class FencedLockUnlockCodec {
    static encodeRequest(groupId, name, sessionId, threadId, invocationUid) {
...
exports.FencedLockUnlockCodec = FencedLockUnlockCodec;
//# sourceMappingURL=FencedLockUnlockCodec.js.map