...
exports.SemaphoreInitCodec = void 0;
...
const REQUEST_PERMITS_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
...
class SemaphoreInitCodec {
    static encodeRequest(groupId, name, permits) {
