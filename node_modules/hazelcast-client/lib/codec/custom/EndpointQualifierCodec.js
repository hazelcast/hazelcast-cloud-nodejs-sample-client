...
exports.EndpointQualifierCodec = void 0;
...
const EndpointQualifier_1 = require("../../core/EndpointQualifier");
...
class EndpointQualifierCodec {
    static encode(clientMessage, endpointQualifier) {
        ...
        FixSizedTypesCodec_1.FixSizedTypesCodec.encodeInt(initialFrame.content, TYPE_OFFSET, endpointQualifier.type);
        clientMessage.addFrame(initialFrame);
        CodecUtil_1.CodecUtil.encodeNullable(clientMessage, endpointQualifier.identifier, StringCodec_1.StringCodec.encode);
    ...
    static decode(clientMessage) {
        ...
        const identifier = CodecUtil_1.CodecUtil.decodeNullable(clientMessage, StringCodec_1.StringCodec.decode);
        CodecUtil_1.CodecUtil.fastForwardToEndFrame(clientMessage);
        return new EndpointQualifier_1.EndpointQualifier(type, identifier);
    }
}
exports.EndpointQualifierCodec = EndpointQualifierCodec;
//# sourceMappingURL=EndpointQualifierCodec.js.map