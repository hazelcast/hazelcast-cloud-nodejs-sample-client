...
class ClusterViewListenerService {
    constructor(logger, connectionManager, partitionService, clusterService, invocationService, connectionRegistry) {
        this.logger = logger;
    ...
    createClusterViewEventHandler(connection) {
        return (clientMessage) => {
            ClientAddClusterViewListenerCodec_1.ClientAddClusterViewListenerCodec.handle(clientMessage, this.clusterService.handleMembersViewEvent.bind(this.clusterService, this.connectionRegistry), (version, partitions) => {
