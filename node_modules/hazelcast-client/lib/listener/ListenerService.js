...
class ListenerService {
    constructor(logger, isSmartService, connectionManager, invocationService, connectionRegistry) {
        this.logger = logger;
    ...
    registerListener(codec, listenerHandlerFn) {
        ...
        for (const connection of activeConnections) {
            ...
            const invocation = new InvocationService_1.Invocation(this.invocationService, requestCopy);
